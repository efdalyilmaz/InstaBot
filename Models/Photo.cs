...
namespace InstaBot.Models
{
    public class Photo
    {
        ...
        public string GetCaption()
        {
            ...
            caption.Append($"#holiday #holidayfun #holidays #travel #travelphotography #travelholic #travelling #traveller #travels #travellers #autumn #autumnleaves #natural #trip #explore #discover {additionalLocationTags}");
